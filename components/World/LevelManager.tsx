...
import { GameObject, ObjectType, LANE_WIDTH, SPAWN_DISTANCE, REMOVE_DISTANCE, GameStatus, NEBULA_COLORS } from '../../types';
                     ...
                     if (isDamageSource) {
                         ...
                         if (isHit) { 
                             ...
                             if (obj.type === ObjectType.ALIEN) {
                                 // Use orange/red for explosion color instead of green
                                 window.dispatchEvent(new CustomEvent('particle-burst', { 
                                    detail: { position: obj.position, color: '#ff5500' } 
                                }));
                                audio.playExplosion();
                             }
                         }
    ...
    if (furthestZ > -SPAWN_DISTANCE) {
         ...
         if (isLetterDue) {
             ...
             if (availableIndices.length > 0) {
                 ...
                 const color = NEBULA_COLORS[chosenIndex];
